...
import { RecipePage } from '@/templates/Recipe';
...
recipe's ids, it was used the getServerSideProps.
*/
/*
Pega os dados da API antes de renderizar a página.
Como é impossível buscar todos os ids das receitas, foi usado getServerSideProps.
*/
