// All categories search template.
// Modelo dos dados retornados ao procurar todas as categorias.
...
// Specific type for a single category.
// Tipo específico de uma categoria.
...
// Type for the all categories API return.
