// All ingredients search template.
// Modelo dos dados retornados ao procurar todos os ingredientes.
...
// Type for the all ingredients API return.
// Tipo para o retorno da API.
export type IngredientsModel = {
    meals: IngredientModel[];
};

// Specific type for a single ingredient.
// Tipo específico de um ingrediente.
